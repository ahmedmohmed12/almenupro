const PERMISSION_KEYS = {
  ...
  RECEIVE_ONLINE_ORDERS: 'receive_online_orders',
...
const PERMISSION_CATALOG = [
  ...
  { key: PERMISSION_KEYS.RECEIVE_ONLINE_ORDERS, category: 'orders' },
...
function ensureRolePermissions(role) {
  ...
  for (const key of ALL_PERMISSION_KEYS) {
    if (permissions[key] === undefined) {
      if (key === PERMISSION_KEYS.RECEIVE_ONLINE_ORDERS) {
        permissions[key] = permissions[PERMISSION_KEYS.PROCESS_ORDERS] === true;
      } else {
...
function permissionAllowed(permissions, permissionKey) {
  ...
  if (permissionKey === PERMISSION_KEYS.RECEIVE_ONLINE_ORDERS) {
    return permissions[PERMISSION_KEYS.PROCESS_ORDERS] === true;
  }
  return false;
}
...
const DEFAULT_POS_ROLES = [
  {
    ...
    permissions: {
      ...
      [PERMISSION_KEYS.RECEIVE_ONLINE_ORDERS]: true,
