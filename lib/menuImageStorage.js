...
const PROXY_HOST_ALLOW =
  /(^|\.)deliveryhero\.io$|(^|\.)talabat\.com$|(^|\.)cloudinary\.com$|(^|\.)googleusercontent\.com$|(^|\.)fbcdn\.net$|(^|\.)cdninstagram\.com$|(^|\.)instagram\.com$|(^|\.)facebook\.com$/i;
  ...
  try {
    const response = await fetch(target.toString(), {
      ...
      headers: {
        ...
        Referer: /fbcdn\.net|cdninstagram\.com|instagram\.com|facebook\.com/i.test(
          target.hostname,
        )
